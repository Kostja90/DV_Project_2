...
>>>>>>> 02b99e7f0c0e168bbf852fdf9f74639237465673
...
#par(mar=c(5,5,4,2))
plot(mean_timbre[,1], mean_timbre[,2], ylim=c(-50,50), xlim=c(35,50), xlab = 'PC1', ylab = 'PC2')
...
title(main = 'PCA timbre for recommended and playlist Songs')
```
...
title(xlab="PC1",ylab="PC2", main = 'PCA pitch for recommended and playlist Songs')
