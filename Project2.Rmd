...
The chossen data is a preferation of a person of our group. The songs he choosed are ordered as followed:
- Beynonce Single Ladies
- Justin Timberlake What Goes Arround Comes Arround
- Kanye West / Lupe Fiasco Touch The Sky
- Madonna Jump


As described below there are two methods to do so.The first one is to access the groups with method h5ls() and the second one to access the data in those groups with method h5read(). One can see a slice of an output underneath.
