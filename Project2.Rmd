...
# Conclusion
To conclude the whole results, one should listen to the recommended songs and make a qualitative analysis and state if this individual indeed likes the recommendended songs. 
...
Besides the bar- and the boxplots, we even found a more profound way of finding smililar songs. We plotted the timbre PCA and found recommended music in the same region plotted as our chosen music.  This assumption would be even better, since it recomended as well 'Shakira' as well as 'Sean Paul', whereas the other assumption did a grading. 
