...
```{r wordclodArtist, echo=TRUE, cache=TRUE}
# Load packages
library("NLP")
...
beyonce_songs <- h5read(toString(SubPaths$beyonce), "/analysis/songs");beyonce_songs
justin_songs <- h5read(toString(SubPaths$justin), "/analysis/songs");justin_songs
kanye_songs <- h5read(toString(SubPaths$kanye), "/analysis/songs");kanye_songs
bruno_songs <- h5read(toString(SubPaths$bruno), "/analysis/songs");bruno_songs
madonna_songs <- h5read(toString(SubPaths$madonna), "/analysis/songs");madonna_songs
